...
export function useMessaging() {
  ...
  const loadConversation = useCallback(async (conversationId: string) => {
    ...
    try {
      ...
      const conversationMessages = await getMessagesForConversation(conversationId, currentUser.uid);
  ...
  const startConversation = useCallback(async (otherUserId: string) => {
    ...
    try {
      ...
      const conversationMessages = await getMessagesForConversation(conversation.id as string, currentUser.uid);
      setMessages(conversationMessages);
